...
export default function Login() {
  ...
  const loginUser = async () => {
    ...
    try {
      await axios.post("http://192.168.137.1:8000/api/login", {
        email,
        password,
      });
...
const styles = StyleSheet.create({
  ...
  passwordInput: {
    ...
    borderColor: "#ccc",
    padding: 10,
    paddingRight: 50, // 👈 important: space for the eye
    borderRadius: 5,
    backgroundColor: "#fff",
  },
  ...
  eyeIcon: {
    ...
    right: 12,
    top: "50%",
    transform: [{ translateY: -10 }], // vertical center
  },
